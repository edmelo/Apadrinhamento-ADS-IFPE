    ...
    answers: [
      {
        ...
        authorInitials: 'RN',
        avatarClass: 'avatar-orange',
        text: 'Geralmente o limite é 25% de faltas por disciplina, mas varia conforme a carga horária. Vale confirmar com cada professor no início do período.',
        time: 'Há 1 h',
      },
      {
        id: 'a2',
        ...
        authorInitials: 'CT',
        avatarClass: 'avatar-purple',
        text: 'Também recomendo já ir de olho no sistema acadêmico ele mostra sua frequência atualizada em cada disciplina.',
        time: 'Há 40 min',
      },
      {
        id: 'a3',
        ...
        authorInitials: 'LM',
        avatarClass: 'avatar-purple',
        text: 'Se perceber que vai passar do limite, fala com a coordenação o quanto antes às vezes dá pra justificar algumas faltas.',
        time: 'Há 20 min',
      },
    ],
  },
    ...
    answers: [
      {
        ...
        authorInitials: 'CT',
        avatarClass: 'avatar-purple',
        text: 'Comecei com exercícios de lógica no site Beecrowd (antigo URI) tem bastante questão de nível iniciante.',
        time: 'Há 20 h',
      },
      {
        id: 'a2',
        ...
        authorInitials: 'RN',
        avatarClass: 'avatar-orange',
        text: 'Também recomendo treinar bastante fluxograma antes de sair escrevendo código direto, ajuda a organizar o raciocínio.',
        time: 'Há 18 h',
      },
    ],
  },
    ...
    answers: [
      {
        ...
        authorInitials: 'LM',
        avatarClass: 'avatar-purple',
        text: 'Os laboratórios de informática ficam todos no bloco B, numerados por andar (Lab 1 e 2 no térreo, 3 e 4 no primeiro andar).',
        time: 'Há 1 dia',
      },
    ],
  },
